<div id="rightMain" class="col-md-12" role="main">
    <a href="index.php?/dlconf/conf_list/" type="button" class="btn btn-default col-md-1">
        <span class="glyphicon glyphicon-arrow-left"></span> 返回
    </a>
    <div style="height: 50px;"></div>

   <form action="index.php?/dlconf/conf_list/" id="btnSaveForm" method="post" class="row">
        <p></p>
        <textarea name="conf" id="conf" class="form-control" rows="20" placeholder="下载配置"><?php echo $preConf;?></textarea>
        <p></p>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btnSave').click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'index.php?/dlconf/judge_file/',
                data:{'conf':conf},
                success:function(data){
                    ...
                    if(jsonObj.result==1){
                        ...
                        $('#myModal').modal();
                        var fstr = '';
                        for(i=0; i<jsonObj.file.length; i++){
