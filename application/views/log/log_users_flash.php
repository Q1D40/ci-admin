...
<table class="table table-hover tbcloth">
    ...
    <tr>
        <th>
            <a href="#" class="tip" data-toggle="tooltip" title="用户Flash版本（mid不除重）">
                Flash版本
            </a>
        </th>
        <th>
            <a href="#" class="tip" data-toggle="tooltip" title="用户Flash版本数量">
                Flash版本数量
            </a>
        </th>
        <th>
            <a href="#" class="tip" data-toggle="tooltip" title="用户Flash版本所占比例">
                Flash版本占比
            </a>
        </th>
    </tr>
    ...
    <tbody>
    <?php foreach($usersFlashList['list'] as $flash => $totalFlash ):?>
        <tr>
            <td><?php echo $flash;?></td>
            <td><?php echo $totalFlash;?></td>
            <td><?php echo round($totalFlash / $usersFlashList['all'], 4) * 100;?>%</td>
        </tr>
    <?php endforeach;?>
    </tbody>
</table>
