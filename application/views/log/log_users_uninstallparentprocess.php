<div id="rightMain" class="col-md-12" role="main">
    ...
    <table class="table table-hover tbcloth">
        ...
        <tr>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="ipr卸载父进程">
                    卸载父进程
                </a>
            </th>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="ipr卸载父进程数量">
                    卸载父进程数量
                </a>
            </th>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="ipr卸载父进程所占比例">
                    卸载父进程占比
                </a>
            </th>
        </tr>
        ...
        <tbody>
        <?php foreach($usersUnpp['list'] as $ipr => $totalIpr ):?>
            <tr>
                <td><?php echo base64_decode($ipr)?></td>
                <td><?php echo $totalIpr;?></td>
                <td><?php echo round($totalIpr / $usersUnpp['all'], 4) * 100;?>%</td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
