<div id="rightMain" class="col-md-12" role="main">
    ...
    <table class="table table-hover">
        ...
        <tbody>
        <?php foreach($feedbackDetailList as $feedbackDetail):?>
            <tr>
                <td><?php echo date('Y-m-d H:i:s', $feedbackDetail['timeStamp']);?></td>
                <td><?php echo $feedbackDetail['ver'];?></td>
                <td><?php echo $feedbackDetail['cid'];?></td>
                <td><?php echo $feedbackDetail['ud'];?></td>
                <td><?php echo $feedbackDetail['uc'];?></td>
                <td>
                    <a target="_blank" href="index.php?/log/feedback_detail_sdata/<?php echo date('Ymd', $feedbackDetail['timeStamp']);?>/<?php echo $feedbackDetail['sid'];?>/">源数据</a>
                </td>
            </tr>
        <?php endforeach;?>
        </tbody>
