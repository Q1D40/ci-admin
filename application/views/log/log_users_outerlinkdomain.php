<div id="rightMain" class="col-md-12" role="main">
    ...
    <table class="table table-hover tbcloth">
        ...
        <tr>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="op2外链域名">
                    外链域名
                </a>
            </th>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="op2外链域名数量">
                    外链域名数量
                </a>
            </th>
            <th>
                <a href="#" class="tip" data-toggle="tooltip" title="op2外链域名所占比例">
                    外链域名占比
                </a>
            </th>
        </tr>
        ...
        <tbody>
        <?php foreach($usersOLD['list'] as $op2 => $totalOp2 ):?>
            <tr>
                <td><?php echo base64_decode($op2)?></td>
                <td><?php echo $totalOp2;?></td>
                <td><?php echo round($totalOp2 / $usersOLD['all'], 4) * 100;?>%</td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
