<div id="rightMain" class="col-md-12" role="main">
    ...
    <table class="table table-hover">
        ...
        <tbody>
        <?php foreach($dbUsageLogList as $dbUsageLog):?>
            <tr>
                <td><?php echo $dbUsageLog['date'];?></td>
                <td><?php echo date('H:i:s', $dbUsageLog['timeStamp']);?></td>
                <td><?php echo round($dbUsageLog['usage']/1024/1024/1024, 2) . 'G'?></td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
